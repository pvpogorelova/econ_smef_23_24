...
logit inlf educ exper expersq age kidslt6 kidsge6 nwifeinc // оценим logit-модели с помощью ММП (логистические шансы). Коэффициент при переменной показывает, во сколько раз изменится логарифм отношения P("удачи")/P("неудачи")
...
predict pl1, pr // прогноз вероятности "успеха"
...
estat clas, cutoff(0.55) // таблица сопряженности y^ и y
...
ologit apply i.pared i.public gpa, or // получим оценки отношения шансов (odds ratio) перейти с одного уровня на более высокий
listcoef, help
