...
* Создадим дамми-переменную doctor = 1, если за год индивидуум посетил хотя бы один раз врача
gen doctor = 0 
...
* Предельные эффекты
margins, dydx(*) atmeans predict(pu0) // by default 

// margins, dydx(*) atmeans predict(pc1) // by default 
