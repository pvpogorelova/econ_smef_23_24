...
* ln(q_it) = b0 + b1*ln(x_1it) + ... + bm*ln(x_mit) - u_i + v_it, где u_i ~ N+(mu, sigma2_u)
...
twoway scatter te_ti te_tvd // диаграмма рассеяния ТЭ по двум моделям
...
hist uhat_tfe
predict te_tfe1, jlms //  exp{−E(u|ε)} (Jondrow et al., 1982)
hist te_tfe1
predict te_tfe2, bc // E{exp(−u|ε)} (Battese, Coelli, 1988)
hist te_tfe2
...
predict uhat_tre, u
hist uhat_tre
predict te_tre1, jlms // JLMS-оценка
hist te_tre1
predict te_tre2, bc // BC-оценка
hist te_tre2
twoway scatter te_tre1 te_tre2 // сравним с помощью диаграммы рассеяния JLMS- и BC-оценки для u
...
predict te_tre3, jlms //  JLMS-оценка
predict te_tre4, bc //  JLMS-оценка
twoway scatter te_tre3 te_tre4

sum te_ti1 te_tvd1 te_fecss1 te_tfe1 te_tre1 te_tre2
spearman te_ti te_tvd te_fecss1 te_tfe1 te_tre1, star(0.05)
